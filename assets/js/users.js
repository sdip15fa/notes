...
function signup () {
    if (!document.getElementById('username').value || !document.getElementById('password').value) {
        document.getElementById('warning').innerHTML = "Username / password cannot be empty.";
        return;
    }
    axios.post("https://notes-server.wcyat.me/users/signup", {username : document.getElementById('username').value, password : document.getElementById('password').value})
